...
| **المحرّكات المغطّاة** | نظرة Google AI العامة، ChatGPT، Claude، Gemini، Yandex Alice (Нейро)، DeepSeek — دليل Perplexity مكتوب بانتظار أوّل تحقّق حيّ |
...
| **المُخرَجات** | لوحة معلومات محلّية (FastAPI + React، أربع لغات) وملف PDF مُنسَّق، من تاريخ محلّي في SQLite |
...
| **تغطية المحرّكات** | ستة محرّكات اليوم، منها **Yandex Alice** و**DeepSeek**؛ إضافة محرّك تعني دليلًا بصيغة markdown لا مُحلِّلًا برمجيًّا | تحدّدها خارطة طريق المزوّد | ما تبنيه أنت وتستمرّ في صيانته |
...
ستة اليوم: **نظرة Google AI العامة، وChatGPT (بحث الويب)، وClaude (بحث الويب)، وGoogle Gemini،
وYandex Alice / Нейро، وDeepSeek (بحث الويب)**. ودليل Perplexity مكتوب وينتظر أوّل جولة تحقّق حيّة.
كل محرّك هو دليل بلغة طبيعية داخل [`engines/`](engines/README.md)، فإضافة محرّك تعني كتابة ملف
markdown لا مُحلِّلًا برمجيًّا.
