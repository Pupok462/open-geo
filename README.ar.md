...
# open-geo — مهارة وكيل لقياس ظهور GEO
...
المصادر ← الاقتباسات) يقول متى لا يمكن الوثوق بجولة بدلًا من التخمين. يعمل بوصفه **مهارة وكيل**:
اطلب القياس فيُنجز الوكيل الالتقاط ويحفظ الجولة ويعيد ملف JSON قابلًا للنقل؛ أمّا PDF ولوحة
المعلومات فاختياريان. لا تحتاج إلى تشغيل خط الأنابيب أو إبقاء خدمة تعمل يدويًّا.
