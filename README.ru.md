...
| **Какие движки** | Google AI Overview, ChatGPT, Claude, Gemini, Yandex Алиса (Нейро), DeepSeek — плейбук Perplexity написан, ждёт live-валидации |
...
| **Деливераблы** | Локальный дашборд (FastAPI + React, 4 языка) и тематический PDF из локальной истории в SQLite |
...
| **Покрытие движков** | Шесть движков сегодня, включая **Yandex Алису** и **DeepSeek**; добавить движок — это markdown-плейбук, а не парсер | Определяется роадмапом вендора | То, что напишете и будете поддерживать сами |
...
Шесть на сегодня: **Google AI Overview, ChatGPT (веб-поиск), Claude (веб-поиск), Google Gemini,
Yandex Алиса / Нейро и DeepSeek (веб-поиск)**. Плейбук Perplexity написан и ждёт первого
live-валидационного прогона. Каждый движок — плейбук на естественном языке в
